...
public class BankAccount {
     ...
     * If the withdrawal would cause a negative balance, a InterruptedException
     * is thrown.
     * Note that an assertion is used to check if this method is thread-safe.
     ...
     */
    public synchronized void withdraw(int amount, BankAccountUser user) throws InterruptedException { //auto generated throw exeption by ide
        int newBalance = balance - amount;
